...
- Publishable packages set `publishConfig.access: public`; private packages remain private. Vendored publication follows [the rescope mapping](docs/rescope.md). `@deepseek-ai/cordis` is a peerDependency (+ dev) of every harness package.
