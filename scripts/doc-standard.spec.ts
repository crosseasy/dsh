...
const PACKAGE_LIBRARIES: Readonly<Record<string, string>> = {
  ...
  'packages/curated/curated-profiles': 'Curated profile template and materialization helpers; plain module exports.',
  'packages/curated/curated-scripts': 'Source-tree curated verification command library; command wrappers own execution.',
  ...
  'packages/shell/shell-runtime': 'Shared one-shot shell executor runtime; consuming shell adapters own registration.',
  'packages/shell/persistent-tool-runtime': 'Shared persistent shell tool runtime; consuming tool packages own registration.',
