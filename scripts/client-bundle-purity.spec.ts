...
describe('client bundle purity gate', () => {
  ...
  it('lets inline-safe libraries inline', () => {
    ...
    expect(resolveId('@deepseek-ai/dsh-llm/brand')).toBeNull()
    expect(resolveId('@deepseek-ai/dsh-llm/call-config')).toBeNull()
    expect(resolveId('@deepseek-ai/dsh-llm/message')).toBeNull()
    expect(resolveId('@deepseek-ai/dsh-llm/types')).toBeNull()
    expect(resolveId('@deepseek-ai/dsh-util-values')).toBeNull()
    expect(resolveId('@deepseek-ai/dsh-plan-mode/client')).toBeNull()
    expect(resolveId('@deepseek-ai/dsh-session-stats/client')).toBeNull()
    expect(resolveId('@deepseek-ai/dsh-token-meter/client')).toBeNull()
    expect(() => resolveId('@deepseek-ai/dsh-llm')).toThrow(/purity/)
    ...
    expect(() => resolveId('@deepseek-ai/dsh-plan-mode')).toThrow(/purity/)
    expect(() => resolveId('@deepseek-ai/dsh-plan-mode/client/internal')).toThrow(/purity/)
    expect(() => resolveId('@deepseek-ai/dsh-session-stats')).toThrow(/purity/)
    expect(() => resolveId('@deepseek-ai/dsh-session-stats/client/internal')).toThrow(/purity/)
  })
