...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  curatedBench: 'curated.md',
  curatedPolicy: 'curated.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  CapabilityConflictRule: 'curated.md',
  CuratedBenchAssetDirs: 'curated.md',
  CuratedBenchAssetKind: 'curated.md',
  CuratedBenchJson: 'curated.md',
  CuratedCandidate: 'curated.md',
  PermissionRule: 'curated.md',
  ...
  WireSettingsDescriptor: 'settings.md',
