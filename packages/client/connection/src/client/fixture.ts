...
function projectionFramesOf(
  ...
  if (usageSampleOf(event) !== undefined) {
    frames.push(
      ...
      { type: 'projection', sessionId: id, key: 'contextPressure', value: foldContextPressureProjection(log), seq: event.seq },
    )
  }
  if (type === 'request/context') {
    frames.push({
      ...
      sessionId: id,
      key: 'contextPressure',
      value: foldContextPressureProjection(log),
      seq: event.seq,
    })
  }
  if (type === 'request/header'
    ...
    frames.push({
      ...
      value: foldContextBreakdownProjection(log),
      seq: event.seq,
    })
  }
