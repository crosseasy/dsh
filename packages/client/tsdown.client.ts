 ...
 */
export const INLINE_SAFE = /^(?:@deepseek-ai\/dsh-(?:file-reference|session|tools|brand|deque|timeout|typert-protocol|util-crypto|util-values|util-workspace-path)(?:\/|$)|@deepseek-ai\/dsh-llm\/(?:brand|call-config|message|types)$|@deepseek-ai\/dsh-plan-mode\/client$|@deepseek-ai\/dsh-session-stats\/client$|@deepseek-ai\/dsh-token-meter\/client$|@deepseek-ai\/dsh-agent-presets\/display$)/
