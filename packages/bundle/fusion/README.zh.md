...
仓库验证遵循 [Fusion 外部 profile 验收](../../../docs/testing.md#tiers)。拥有该决策的 [Agent Note](../../../.agents/notes/implemented/architecture/2026-08-19-fusion-profile-external-plugin-ownership.md) 记录持久准入与验证要求。
