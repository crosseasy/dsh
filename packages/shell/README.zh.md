...
| [`shell-runtime/`](shell-runtime/README.zh.md) | 为 Bash 与 PowerShell adapter 共享一次性进程生命周期与 sandbox settlement。 | （helper 包） |
...
| [`persistent-tool-runtime/`](persistent-tool-runtime/README.zh.md) | 为 Bash 与 PowerShell adapter 共享持久 shell 生命周期机制。 | （helper 包） |
| [`tool-bash-persistent/`](tool-bash-persistent/README.zh.md) | 向模型公开 owner 作用域的持久 Bash PTY。 | （注册到 `ctx.tools`） |
| [`tool-pwsh-persistent/`](tool-pwsh-persistent/README.zh.md) | 向模型公开 owner 作用域的持久 PowerShell PTY。 | （注册到 `ctx.tools`） |
