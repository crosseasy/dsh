...
The package root exports the default and named `SandboxBashExecutor` plugin plus its `Config`; sandbox result classification comes from the shared `@deepseek-ai/dsh-shell` implementation.
