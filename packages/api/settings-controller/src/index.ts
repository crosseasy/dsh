...
import { settingsNamespace, type SettingsPathOp, type SettingsProvider, type WireSettingsDescriptor } from '@deepseek-ai/dsh-settings'
import type {
...
export class SettingsController extends TypertRemoteService {
  ...
  private async write(
    ...
    const descriptor = settings.describeForWire(settingsNamespace(namespace))
